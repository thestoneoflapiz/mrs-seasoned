...
export default function BestSellerReporting({ filterBy, fMonth, fYear }){
    ...
    <>
      ...
      <Container className={styles.c_report_container}>
        ...
        {!isLoading && (
          <Row>
            <Col xs={12}>
              <h5 className='text-light'>Best Seller of <span className='fw-bold'>{filterBy=="month" && moment(fMonth).format("MMMM")} {fYear}</span></h5>
            </Col>
            <Col>
