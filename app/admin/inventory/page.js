...
import AddInventoryModal from "./_modals/add";
import ImportInventoryCSVModal from "./_modals/import";
...
export default function InventoryPage(){
  ...
  return(
    <main className={styles.main}>
          ...
          <Row>
            <Col>
              ...
              <Breadcrumb>
                ...
                <Breadcrumb.Item className={styles.c_link} active>Inventory</Breadcrumb.Item>
              </Breadcrumb>
            </Col>
          </Row>
      ...
      <AddInventoryModal show={showAddModal} onModalClose={handleAddModalClose} />
      <ImportInventoryCSVModal show={showImportModal} onModalClose={handleImportModalClose} />
    </main>
  );
}