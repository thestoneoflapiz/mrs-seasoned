...
export default function DeleteCOModal({ show, onModalClose, data }){
  ...
  async function deleteCO(){
    const response = await fetch("/api/cash_out/delete", {
      method: "POST",
      body: JSON.stringify({
        _id: itemDetails._id
      },{
    ...
    <>
      ...
      >
          ...
          <Modal.Body>
            ...
            <p>Are you sure to delete {itemDetails?.item || " item"}?</p>
            <Row className="justify-content-end align-items-center">
              <Col sm={3} xs={4}>
                <Button type="button" variant="primary" onClick={deleteCO}>Yes</Button>
              </Col>
              <Col sm={3} xs={4}>
